...
export const mockLeaderboardUsers = [
  ...
  { id: "user_misan", rank: 4, name: "You", initials: "ME", examTrack: "Sakha Adhikrit", weeklyXP: 1800, monthlyXP: 6100, lifetimeXP: 15800, examXP: 1800, tournamentPoints: 6100, tournamentAccuracy: 82, speedBonus: 240, reward: "300 coins + 300 XP", accuracy: 82, streak: 6, longestStreak: 13, badges: 10, tournamentWins: 1, rankTitle: "New Aspirant", trend: "up", isCurrentUser: true, subjectStats: subjectStats(1120, 82, 132) },
...
// Badge *catalog* — definitions only. Earned state, real progress, and earned
// date are computed at runtime by the badge engine (utils/badgeUtils.js) from
// actual user activity and never hardcoded here. Each badge carries:
//   target       -> requirement value the engine evaluates real progress against
//   reward       -> reward text (applied once via the engine's reward ledger)
//   shape        -> outer geometry (Mythic always starburst)
//   iconKind     -> center glyph
//   isSecret     -> hidden "???" badge until earned
// The unlock condition for each id lives in EVALUATORS (+ ELIGIBILITY gates)
// inside badgeUtils.js — every badge has a real, data-driven condition.
export const mockBadges = [
  { id: "first_step", name: "First Step Badge", description: "Complete your first quiz.", category: "Starter", rarity: "Common", target: 1, icon: "starter", shape: "pentagon", iconKind: "star", isSecret: false, reward: "+20 XP" },
  { id: "constitution_starter", name: "Constitution Starter", description: "Complete your first Constitution practice.", category: "Practice", rarity: "Common", target: 1, icon: "book", shape: "pentagon", iconKind: "book", isSecret: false, reward: "+20 XP" },
  { id: "daily_learner", name: "Daily Learner", description: "Complete 3 daily quizzes.", category: "Daily Quiz", rarity: "Common", target: 3, icon: "calendar", shape: "crown", iconKind: "calendar", isSecret: false, reward: "+50 XP" },
  { id: "seven_day_warrior", name: "7-Day Warrior", description: "Maintain a 7-day study streak.", category: "Streak", rarity: "Rare", target: 7, icon: "fire", shape: "hexagon", iconKind: "flame", isSecret: false, reward: "+150 coins" },
  { id: "thirty_day_legend", name: "30-Day Legend", description: "Maintain a 30-day study streak.", category: "Streak", rarity: "Epic", target: 30, icon: "fire", shape: "hexagon", iconKind: "flame", isSecret: false, reward: "+500 coins" },
  { id: "mock_beginner", name: "Mock Beginner", description: "Complete your first mock test.", category: "Mock Test", rarity: "Common", target: 1, icon: "clipboard", shape: "pentagon", iconKind: "clipboard", isSecret: false, reward: "+50 XP" },
  { id: "mock_master", name: "Mock Master", description: "Complete 10 mock tests.", category: "Mock Test", rarity: "Rare", target: 10, icon: "clipboard", shape: "pentagon", iconKind: "clipboard", isSecret: false, reward: "+300 XP" },
  { id: "gk_champion", name: "GK Champion", description: "Score 90% or above in General Knowledge.", category: "Subject Mastery", rarity: "Rare", target: 90, icon: "target", shape: "shield", iconKind: "target", isSecret: false, reward: "+100 XP" },
  { id: "constitution_expert", name: "Constitution Expert", description: "Reach 85% accuracy in Constitution of Nepal.", category: "Subject Mastery", rarity: "Rare", target: 85, icon: "book", shape: "shield", iconKind: "book", isSecret: false, reward: "+100 XP" },
  { id: "accuracy_master", name: "Accuracy Master", description: "Maintain 85% overall accuracy.", category: "Accuracy", rarity: "Epic", target: 85, icon: "target", shape: "circle", iconKind: "target", isSecret: false, reward: "+200 XP" },
  { id: "friday_fighter", name: "Friday Fighter", description: "Join your first Friday tournament.", category: "Tournament", rarity: "Common", target: 1, icon: "trophy", shape: "starburst", iconKind: "trophy", isSecret: false, reward: "+50 coins" },
  { id: "friday_champion", name: "Friday Champion", description: "Rank 1 in a Friday tournament.", category: "Tournament", rarity: "Legendary", target: 1, icon: "trophy", shape: "starburst", iconKind: "trophy", isSecret: false, reward: "500 coins + 500 XP" },
  { id: "top_10_contender", name: "Top 10 Contender", description: "Place in the top 10 of a Friday tournament.", category: "Tournament", rarity: "Rare", target: 1, icon: "medal", shape: "starburst", iconKind: "trophy", isSecret: false, reward: "Top Performer title" },
  { id: "comeback_learner", name: "Comeback Learner", description: "Return after missing 3 study days.", category: "Streak", rarity: "Rare", target: 1, icon: "refresh", shape: "hexagon", iconKind: "lightning", isSecret: false, reward: "+50 XP" },
  { id: "subject_specialist", name: "Subject Specialist", description: "Complete 100 questions in one subject.", category: "Subject Mastery", rarity: "Epic", target: 100, icon: "book", shape: "shield", iconKind: "book", isSecret: false, reward: "+200 XP" },
  { id: "public_service_master", name: "Public Service Master", description: "Reach Public Service Master rank.", category: "Rank", rarity: "Legendary", target: 12000, icon: "crown", shape: "crown", iconKind: "crown", isSecret: false, reward: "Special rank frame" },
  { id: "perfect_daily", name: "Perfect Daily", description: "Score 10/10 in a daily quiz.", category: "Daily Quiz", rarity: "Rare", target: 10, icon: "check", shape: "crown", iconKind: "star", isSecret: false, reward: "+30 XP" },
  { id: "review_hero", name: "Review Hero", description: "Master 25 wrong answers through review.", category: "Review", rarity: "Rare", target: 25, icon: "review", shape: "shield", iconKind: "clipboard", isSecret: false, reward: "+100 XP" },
  { id: "no_mistake_run", name: "No Mistake Run", description: "Complete a practice set without any wrong answer.", category: "Accuracy", rarity: "Epic", target: 1, icon: "target", shape: "circle", iconKind: "target", isSecret: false, reward: "+150 XP" },
  { id: "early_bird", name: "Early Bird", description: "Complete daily quiz before 8 AM.", category: "Daily Quiz", rarity: "Rare", target: 1, icon: "sun", shape: "crown", iconKind: "star", isSecret: false, reward: "+30 coins" },
  { id: "night_owl", name: "Night Owl", description: "Study after 10 PM for 5 days.", category: "Streak", rarity: "Rare", target: 5, icon: "moon", shape: "hexagon", iconKind: "star", isSecret: false, reward: "+60 coins" },
  { id: "loksewa_warrior", name: "Loksewa Warrior", description: "Reach 8,000 XP.", category: "Rank", rarity: "Epic", target: 8000, icon: "shield", shape: "crown", iconKind: "target", isSecret: false, reward: "Warrior title" },
  { id: "rare_climber", name: "Rare Climber", description: "Move up 20 leaderboard positions in one week.", category: "Leaderboard", rarity: "Legendary", target: 20, icon: "trending", shape: "starburst", iconKind: "lightning", isSecret: false, reward: "Rare Climber badge" },

  // --- Mythic tier: the rarest achievements (starburst shape, coral gradient) ---
  { id: "prepquest_legend", name: "PrepQuest Legend", description: "Reach 20,000 XP.", category: "Rank", rarity: "Mythic", target: 20000, icon: "crown", shape: "starburst", iconKind: "crown", isSecret: false, reward: "Legend profile theme" },
  { id: "flawless_mind", name: "Flawless Mind", description: "Answer 500 questions at 95%+ overall accuracy.", category: "Accuracy", rarity: "Mythic", target: 500, icon: "target", shape: "starburst", iconKind: "target", isSecret: false, reward: "Mythic profile aura" },
