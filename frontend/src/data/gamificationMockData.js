...
// Each badge carries visual metadata for the gem-style BadgeIcon:
//   shape    -> outer geometry, derived from category (Mythic always starburst)
//   iconKind -> center glyph
//   isSecret -> hidden "???" badge until earned
export const mockBadges = [
  { id: "first_step", name: "First Step Badge", description: "Complete your first quiz.", category: "Starter", rarity: "Common", status: "earned", progress: 1, target: 1, icon: "starter", shape: "pentagon", iconKind: "star", isSecret: false, reward: "+20 XP", earnedAt: "2026-06-20" },
  { id: "constitution_starter", name: "Constitution Starter", description: "Complete your first Constitution practice.", category: "Practice", rarity: "Common", status: "earned", progress: 1, target: 1, icon: "book", shape: "pentagon", iconKind: "book", isSecret: false, reward: "+20 XP", earnedAt: "2026-06-20" },
  { id: "daily_learner", name: "Daily Learner", description: "Complete 3 daily quizzes.", category: "Daily Quiz", rarity: "Common", status: "earned", progress: 3, target: 3, icon: "calendar", shape: "crown", iconKind: "calendar", isSecret: false, reward: "+50 XP", earnedAt: "2026-06-21" },
  { id: "seven_day_warrior", name: "7-Day Warrior", description: "Maintain a 7-day study streak.", category: "Streak", rarity: "Rare", status: "locked", progress: 4, target: 7, icon: "fire", shape: "hexagon", iconKind: "flame", isSecret: false, reward: "+150 coins", earnedAt: null },
  { id: "thirty_day_legend", name: "30-Day Legend", description: "Maintain a 30-day study streak.", category: "Streak", rarity: "Epic", status: "locked", progress: 4, target: 30, icon: "fire", shape: "hexagon", iconKind: "flame", isSecret: false, reward: "+500 coins", earnedAt: null },
  { id: "mock_beginner", name: "Mock Beginner", description: "Complete your first mock test.", category: "Mock Test", rarity: "Common", status: "locked", progress: 0, target: 1, icon: "clipboard", shape: "pentagon", iconKind: "clipboard", isSecret: false, reward: "+50 XP", earnedAt: null },
  { id: "mock_master", name: "Mock Master", description: "Complete 10 mock tests.", category: "Mock Test", rarity: "Rare", status: "locked", progress: 0, target: 10, icon: "clipboard", shape: "pentagon", iconKind: "clipboard", isSecret: false, reward: "+300 XP", earnedAt: null },
  { id: "gk_champion", name: "GK Champion", description: "Score 90% or above in General Knowledge.", category: "Subject Mastery", rarity: "Rare", status: "locked", progress: 86, target: 90, icon: "target", shape: "shield", iconKind: "target", isSecret: false, reward: "+100 XP", earnedAt: null },
  { id: "constitution_expert", name: "Constitution Expert", description: "Reach 85% accuracy in Constitution of Nepal.", category: "Subject Mastery", rarity: "Rare", status: "locked", progress: 72, target: 85, icon: "book", shape: "shield", iconKind: "book", isSecret: false, reward: "+100 XP", earnedAt: null },
  { id: "accuracy_master", name: "Accuracy Master", description: "Maintain 85% overall accuracy.", category: "Accuracy", rarity: "Epic", status: "locked", progress: 72, target: 85, icon: "target", shape: "circle", iconKind: "target", isSecret: false, reward: "+200 XP", earnedAt: null },
  { id: "friday_fighter", name: "Friday Fighter", description: "Join your first Friday tournament.", category: "Tournament", rarity: "Common", status: "locked", progress: 0, target: 1, icon: "trophy", shape: "starburst", iconKind: "trophy", isSecret: false, reward: "+50 coins", earnedAt: null },
  { id: "friday_champion", name: "Friday Champion", description: "Rank 1 in a Friday tournament.", category: "Tournament", rarity: "Legendary", status: "locked", progress: 0, target: 1, icon: "trophy", shape: "starburst", iconKind: "trophy", isSecret: false, reward: "500 coins + 500 XP", earnedAt: null },
  { id: "top_10_contender", name: "Top 10 Contender", description: "Place in the top 10 of a Friday tournament.", category: "Tournament", rarity: "Rare", status: "locked", progress: 0, target: 1, icon: "medal", shape: "starburst", iconKind: "trophy", isSecret: false, reward: "Top Performer title", earnedAt: null },
  { id: "comeback_learner", name: "Comeback Learner", description: "Return after missing 3 study days.", category: "Streak", rarity: "Rare", status: "locked", progress: 0, target: 1, icon: "refresh", shape: "hexagon", iconKind: "lightning", isSecret: false, reward: "+50 XP", earnedAt: null },
  { id: "subject_specialist", name: "Subject Specialist", description: "Complete 100 questions in one subject.", category: "Subject Mastery", rarity: "Epic", status: "locked", progress: 86, target: 100, icon: "book", shape: "shield", iconKind: "book", isSecret: false, reward: "+200 XP", earnedAt: null },
  { id: "public_service_master", name: "Public Service Master", description: "Reach Public Service Master rank.", category: "Rank", rarity: "Legendary", status: "locked", progress: 120, target: 12000, icon: "crown", shape: "crown", iconKind: "crown", isSecret: false, reward: "Special rank frame", earnedAt: null },
  { id: "perfect_daily", name: "Perfect Daily", description: "Score 10/10 in a daily quiz.", category: "Daily Quiz", rarity: "Rare", status: "locked", progress: 8, target: 10, icon: "check", shape: "crown", iconKind: "star", isSecret: false, reward: "+30 XP", earnedAt: null },
  { id: "review_hero", name: "Review Hero", description: "Master 25 wrong answers through review.", category: "Review", rarity: "Rare", status: "locked", progress: 9, target: 25, icon: "review", shape: "shield", iconKind: "clipboard", isSecret: false, reward: "+100 XP", earnedAt: null },
  { id: "no_mistake_run", name: "No Mistake Run", description: "Complete a practice set without any wrong answer.", category: "Accuracy", rarity: "Epic", status: "locked", progress: 0, target: 1, icon: "target", shape: "circle", iconKind: "target", isSecret: false, reward: "+150 XP", earnedAt: null },
  { id: "early_bird", name: "Early Bird", description: "Complete daily quiz before 8 AM.", category: "Daily Quiz", rarity: "Rare", status: "locked", progress: 0, target: 1, icon: "sun", shape: "crown", iconKind: "star", isSecret: false, reward: "+30 coins", earnedAt: null },
  { id: "night_owl", name: "Night Owl", description: "Study after 10 PM for 5 days.", category: "Streak", rarity: "Rare", status: "locked", progress: 2, target: 5, icon: "moon", shape: "hexagon", iconKind: "star", isSecret: false, reward: "+60 coins", earnedAt: null },
  { id: "loksewa_warrior", name: "Loksewa Warrior", description: "Reach 8,000 XP.", category: "Rank", rarity: "Epic", status: "locked", progress: 120, target: 8000, icon: "shield", shape: "crown", iconKind: "target", isSecret: false, reward: "Warrior title", earnedAt: null },
  { id: "rare_climber", name: "Rare Climber", description: "Move up 20 leaderboard positions in one week.", category: "Leaderboard", rarity: "Legendary", status: "locked", progress: 5, target: 20, icon: "trending", shape: "starburst", iconKind: "lightning", isSecret: false, reward: "Rare Climber badge", earnedAt: null },

  // --- Mythic tier: the rarest achievements (starburst shape, coral gradient) ---
  { id: "prepquest_legend", name: "PrepQuest Legend", description: "Reach 20,000 XP.", category: "Rank", rarity: "Mythic", status: "locked", progress: 120, target: 20000, icon: "crown", shape: "starburst", iconKind: "crown", isSecret: false, reward: "Legend profile theme", earnedAt: null },
  { id: "flawless_mind", name: "Flawless Mind", description: "Answer 500 questions with 100% accuracy.", category: "Accuracy", rarity: "Mythic", status: "locked", progress: 62, target: 500, icon: "target", shape: "starburst", iconKind: "target", isSecret: false, reward: "Mythic profile aura", earnedAt: null },
  { id: "streak_centurion", name: "Centurion", description: "Maintain a 100-day study streak.", category: "Streak", rarity: "Mythic", status: "locked", progress: 4, target: 100, icon: "fire", shape: "starburst", iconKind: "flame", isSecret: false, reward: "Eternal Flame frame", earnedAt: null },
  { id: "omnischolar", name: "Omnischolar", description: "Complete every subject's mastery track.", category: "Subject Mastery", rarity: "Mythic", status: "locked", progress: 1, target: 8, icon: "book", shape: "starburst", iconKind: "book", isSecret: false, reward: "Omnischolar title + theme", earnedAt: null },
  { id: "tournament_apex", name: "Tournament Apex", description: "Finish in the top 1% of a Friday tournament.", category: "Tournament", rarity: "Mythic", status: "locked", progress: 0, target: 1, icon: "trophy", shape: "starburst", iconKind: "trophy", isSecret: true, reward: "Apex Champion crown", earnedAt: null },
];
